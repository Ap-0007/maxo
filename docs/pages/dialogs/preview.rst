...
с превью всех своих окон. Кнопки кликабельны и переключают окна:

.. image:: /_static/preview-demo.gif
   :alt: HTML-превью диалога
   :width: 520px
...
.. image:: /_static/transitions-example.png
   :alt: Диаграмма переходов
   :width: 600px
