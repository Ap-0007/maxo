    ...
    Объект `Update` описывает возможные события в чате или канале. Может возвращаться в следующих случаях:
     ...
     ## Типы событий
        ...
        - `message_callback` - пользователь нажал на кнопку в чате или канале
         - `message_created` - пользователь или бот отправил новое сообщение, опубликовал пост или комментарий
        - `message_edited` - пользователь или бот отредактировал сообщение в чате, пост в канале или комментарий к посту. Обратите внимание, боты могут изменять только свои комментарии
        - `message_removed` - пользователь или бот удалил сообщение из чата, пост из канала или комментарий к посту
